...
namespace HMSX.SCZZ.CJGL.MES
{
    ...
    public class SCJDCX:AbstractDynamicFormPlugIn
    {
        ...
        public override void AfterButtonClick(AfterButtonClickEventArgs e)
        {
            ...
            {
                DynamicObject wlobj = (DynamicObject)this.View.Model.GetValue("FCXWL");
                long wl = Convert.ToInt64(wlobj["Id"]);
                string num = wlobj["Number"].ToString();
                string gzh = "";
                if (num.StartsWith("260.02"))
                {
                    gzh = this.View.Model.GetValue("F_260_JHGZH") == null ? "" : this.View.Model.GetValue("F_260_JHGZH").ToString();
                    jhgzh = gzh;
                }
        ...
        public override void EntityRowDoubleClick(EntityRowClickEventArgs e)
        {
            ...
            if (e.Key== "F_PAEZ_SCJD")
            {
                ...
                string wlnum = ((DynamicObject)this.View.Model.GetValue("FWLNumber", e.Row))["Number"].ToString();
                string gzh = "";
                if (wlnum.StartsWith("260.02"))
                {
                    gzh = jhgzh;
                }
                string mxsql = $"exec SP_260_SCJDMX {wlid},'{gzh}'";
        ...
        private void filldata(long wl,int parent,string gzh)
        {
            string scsql = $"exec SP_260_SCJDCX {wl},'{gzh}'";
        ...
        //需求明细
        private void xqdata(long wl,string gzh)
        {
            string xqsql = $"exec sp_260_GETXQ {wl},'{gzh}'";
