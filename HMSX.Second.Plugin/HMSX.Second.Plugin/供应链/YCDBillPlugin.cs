...
{
    [Description("预测单--项目号过滤")]    
    //热启动,不用重启IIS
    [Kingdee.BOS.Util.HotUpdate]
    public class YCDBillPlugin:AbstractBillPlugIn
    {
        ...
        public override void AfterDoOperation(AfterDoOperationEventArgs e)
        {
            ...
            {
                if (e.Operation.OperationId == 9 && e.Operation.Operation == "Submit" && e.OperationResult.IsSuccess ||
                    e.Operation.OperationId == 8 && e.Operation.Operation == "SLSB_SAVE" && e.OperationResult.IsSuccess)
                {
